...
Color grayscale = Color(0xffEBEBEB);
Color darkGreyColor = Color(0xffBDBDBD);
Color darkenGreyColor = Color(0xff666666);
Color blackColor = Color(0xff2F2E36);
...
TextStyle greenSemiBoldTextStyle = GoogleFonts.inter(
  fontWeight: FontWeight.w600,
  color: greenColor,
);

TextStyle greenRegularTextStyle = GoogleFonts.inter(
  fontWeight: FontWeight.w400,
  color: greenColor,
);
