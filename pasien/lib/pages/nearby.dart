...
//   List<RumahSakit> _nearbyLocations(QuerySnapshot snapshot) {
//     return snapshot.docs.map((DocumentSnapshot doc) {
//       final data = doc.data() as Map<String, dynamic>;
//       final name = data['name'] as String;
//       final map = data['map'] as GeoPoint;
...
//   // List<RumahSakit> _nearbyLocations = [];
...
//                 RumahSakit location = _nearbyLocations[index];
//                 return ListTile(
...
//     //   ),
//     // ];
//     List<RumahSakit> locations(QuerySnapshot snapshot) {
//       return snapshot.docs.map((DocumentSnapshot doc) {
//         final data = doc.data() as Map<String, dynamic>;
//         final name = data['name'] as String;
//         final map = data['map'] as GeoPoint;
